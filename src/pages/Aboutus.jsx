...
const legacyLeaders = [
  {
    ...
    roles: [
      "Principal · 1998 — 1999",
      "Head of Senior School · 1997 — 1999",
    ],
  },
  {
  ...
  },
  {
    ...
    roles: [
      "Principal · 2000 — 2006",
      "Head of Junior School · 2000 — 2006",
    ],
  },
  {
    name: "Rekha Bakshi",
...
const Reveal = ({
  ...
  return (
    <div
      ref={ref}
      className={`about-reveal about-reveal-${direction} ${className}`}
...
const About = () => {
  ...
  return (
    <main className="overflow-hidden bg-[#F7F4EF] text-[#211B1C]">
      ...
      <section className="mx-auto max-w-[1440px] px-5 pb-20 pt-12 sm:px-8 lg:px-12 lg:pb-28 lg:pt-16">
        ...
        <div className="grid items-end gap-8 lg:grid-cols-[0.65fr_1.35fr]">
          ...
          <div className="relative z-10">
            ...
            <h1 className="font-sans text-[clamp(5.5rem,12vw,11rem)] font-semibold leading-[0.72] tracking-[-0.08em] lg:mr-15">
              ...
              <span className="about-title-line">
                <span className="about-title-word about-title-second">
                  US
                </span>
              </span>
        ...
        <Reveal delay={400}>
          <div className="mt-12 flex justify-end">
            ...
            <div className="group flex items-center gap-3 text-[10px] uppercase tracking-[0.2em] text-[#8E1731]">
          ...
          <Reveal direction="right" delay={150}>
            ...
            <div className="max-w-[540px] space-y-6 self-end text-[15px] leading-8 text-[#665D5E]">
              ...
              <p>
                ...
                realisation of Mr. Aroon Purie and Mrs. Rekha Purie&apos;s
              ...
              <p>
                ...
                being a good citizen was more important than simply being a
                good student.
              </p>

              <p>
                Vasant Valley School aims to nurture independent minds and
                create a space where students are encouraged to actualise their
      ...
      <section className="overflow-hidden bg-[#8E1731]">
      ...
      <section className="mx-auto max-w-[1280px] px-5 py-20 sm:px-8 lg:px-12 lg:py-32">
              ...
              <div>
                ...
                <div className="group overflow-hidden rounded-[28px] bg-[#E7E0DC]">
                  ...
                  <img
                    src={person.image}
                    alt={person.name}
                    className="h-[480px] w-full object-cover transition-transform duration-1000 group-hover:scale-[1.05] sm:h-[580px]"
                  />

                </div>

                <div className="group mt-6 flex items-end justify-between border-b border-[#DCD3CF] pb-5">
                  ...
                  <ArrowRight
                    size={18}
                    className="text-[#8E1731] transition-transform duration-300 group-hover:translate-x-2"
                  />
        ...
        <Reveal direction="right">
          ...
          <p className="mt-16 max-w-[620px] text-[15px] leading-8 text-[#665D5E] lg:ml-auto">
            ...
            Together, Mr. and Mrs. Purie envisioned an environment that would
            give children the freedom and opportunity to discover their
              ...
              <div className="relative grid gap-8 pb-20 pl-10 lg:grid-cols-2 lg:gap-24 lg:pl-0">
                ...
                <div className="lg:pl-16">
                  ...
                  <div className="mt-6 max-w-[480px] space-y-5 text-[14px] leading-7 text-white/65">
                    ...
                    <p>
                      Founder-Principal of Modern School, Vasant Vihar, Mr.
                      Vyas worked closely with Mr. and Mrs. Purie during the
                      initial years to establish Vasant Valley&apos;s vision and
                      philosophy.
                    </p>
              ...
              <div className="relative grid pl-10 lg:grid-cols-2 lg:gap-24 lg:pl-0">
                ...
                <div className="lg:pr-16 lg:text-right">
                  ...
                  <div className="mt-6 max-w-[480px] space-y-5 text-[14px] leading-7 text-white/65 lg:ml-auto">
                    ...
                    <p>
                      Mr. Arun Kapur was appointed the first Headmaster of
                      Vasant Valley School in 1990.
                    </p>

                    <p>
                      Along with the initial group of 16 teachers, he ensured
                      the implementation of the School&apos;s vision and
                      continued to head the School for the next 30 years, until
                      his retirement in 2020.
                    </p>

                    <p>
                      Under his leadership, Vasant Valley grew from strength to
                      strength and gained recognition as one of India&apos;s
                      foremost coeducational day schools.
                    </p>
      ...
      <section className="mx-auto max-w-[1280px] px-5 py-20 sm:px-8 lg:px-12 lg:py-32">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-2">
          ...
          <Reveal direction="right">
            ...
            <p className="max-w-[500px] self-end text-[15px] leading-8 text-[#665D5E]">
              The School stands proud and tall on the shoulders of those who
              have strengthened the motto of Excellence in Deed over the years.
            </p>
          ...
          {legacyLeaders.map((leader, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="border-b border-[#D4CCCA]">

                  <button
                    type="button"
                    onClick={() =>
                      setOpenLeader(isOpen ? null : index)
                    }
                  ...
                  >
                    ...
                    <div className="flex h-9 w-9 items-center justify-center rounded-full border border-[#CFC5C2] transition-all duration-300 group-hover:bg-[#8E1731] group-hover:text-white">
      ...
      <section className="bg-[#EAE4DF]">
        ...
        <div className="mx-auto max-w-[1280px] px-5 py-20 sm:px-8 lg:px-12 lg:py-32">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            ...
            {currentLeadership.map((person, index) => (
                ...
                <div className="group">
                  ...
                  <div className="overflow-hidden rounded-[24px] bg-[#DCD4CF]">
                    ...
                    <img
                      src={person.image}
                      alt={person.name}
                      className="h-[390px] w-full object-cover transition-transform duration-1000 group-hover:scale-[1.05]"
                    />
      ...
      <section className="mx-auto max-w-[1280px] px-5 py-20 sm:px-8 lg:px-12 lg:py-32">
        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
          ...
          <Reveal direction="left">
            ...
            <div>
              ...
              <p className="mt-7 max-w-[470px] text-[14px] leading-7 text-[#665D5E]">
                ...
                around the Areas of Development, helping nurture the whole
                child.
              </p>
          ...
          <div className="border-t border-[#D4CCCA]">
            ...
            {developmentAreas.map(([number, title], index) => (
              ...
              >
                ...
                <div className="group flex items-center border-b border-[#D4CCCA] py-6 sm:py-7">

                  <span className="w-14 text-[10px] tracking-[0.2em] text-[#8E1731]">
                    {number}
                  </span>

                  <h3 className="flex-1 font-serif text-[27px] transition-transform duration-300 group-hover:translate-x-3 sm:text-[35px]">
                    {title}
                  </h3>
          ...
          <div className="mt-12 grid gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:gap-16">
            ...
            <Reveal direction="right">
              ...
              <p className="max-w-[470px] self-end text-[14px] leading-7 text-white/60">
                ...
                of commitment and a passion for learning. More than 150
                teachers bring expertise as educators, writers, musicians,
                theatre artists, sportspersons, professionals and mentors.
              </p>
            ...
            <Reveal direction="right">
              ...
              <div className="space-y-5 text-[14px] leading-7 text-white/60">
                ...
                <p>
                  ...
                  across the world to understand global best practices and
                  share their learning with colleagues and students.
                </p>
          ...
          <Reveal direction="right">
            ...
            <div className="self-end">
              ...
              <p className="mt-7 max-w-[500px] text-[14px] leading-7 text-[#665D5E]">
                ...
                and found their calling across the world. Their school
                experience has created bonds that have remained strong, and
                some alumni are now parents whose children form the next
                generation of the Vasant Valley community.
              </p>

              <a
                href="mailto:alumni@vasantvalley.edu.in"
                className="group mt-8 inline-flex items-center gap-3 rounded-full bg-[#8E1731] px-6 py-3.5 text-[12px] font-semibold text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
...
const Stat = ({ value, label }) => {
  return (
    <div className="group border-b border-[#D4CCCA] py-10 sm:border-b-0 sm:border-r sm:px-8 sm:py-12 sm:last:border-r-0 lg:px-12">

      <p className="font-serif text-[65px] leading-none tracking-[-0.05em] text-[#8E1731] transition-transform duration-500 group-hover:-translate-y-1 lg:text-[82px]">
        {value}
      </p>
